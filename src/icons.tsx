...
export const Upload: Component = () => {
  ...
  return (
    <>
      <input ref={file} type="file" hidden onChange={load}></input>
      <svg onclick={()=>{if(file)file.click()}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
